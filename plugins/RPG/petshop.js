    ...
    if (/petshop/i.test(command)) {
      ...
      switch (type) {
        ...
        case "lion":
          ...
          break;
        case "kirana":
          if (user.kirana > 0) return m.reply("Kamu sudah memilik ini");
          if (user.pet < hkirana) return m.reply(`Pet Token anda kurang`);
          global.db.data.users[m.sender].pet -= hkirana;
          global.db.data.users[m.sender].kirana += 1;
          m.reply("Selamat anda mempunyai pet Baru ! 🎉");
          break;
        case "dragon":
