...
const inventory = {
  ...
  tools: {
    ...
    pickaxe: {
      ...
      11: "Sanz`s Exclusive 100 Level Pickaxe",
    },
    fishingrod: {
      0: "❌",
      1: "Wooden Fishingrod",
...
${
  user.donate > 10000
    ? "🏅 Dᴏɴᴀᴛᴜʀ\nᵈⁱᵈᵃᵖᵃᵗᵏᵃⁿ ᵏᵃʳⁿᵃ ᵈᵒⁿᵃᵗᵉ ᵒʷⁿᵉʳ\n"
    : ""
} ${
  user.donate > 50000
    ? "🎫 Sᴜʟᴛᴀɴ\nᵈⁱᵈᵃᵖᵃᵗᵏᵃⁿ ᵏᵃʳⁿᵃ ᵈᵒⁿᵃᵗᵉ ⁵⁰ᵏ ᵒʷⁿᵉʳ\n"
    : ""
} ${
  user.level > 99
    ? "🛐 Sᴇᴘᴜʜ\nᵈᶦᵈᵃᵖᵃᵗᵏᵃⁿ ᵏᵃʳᵉⁿᵃ ˢᵘᵈᵃʰ ᵐᵉⁿᶜᵃᵖᵃᶦ ˡᵉᵛᵉˡ ¹⁰⁰\n"
    : ""
} ${
  user.dragon > 99
  ...
  await conn.reply(m.chat, caption, m, {
    contextInfo: {
      externalAdReply: {
        ...
        mediaUrl: "https://chat.whatsapp.com/CAZ9X5zRMY8Dd1Lx2BVOi5",
        sourceId: botName,
        sourceUrl: "https://chat.whatsapp.com/CAZ9X5zRMY8Dd1Lx2BVOi5",
      },
    },
  });
};
